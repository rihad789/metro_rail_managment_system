    ...
    <div class="row">
        <div class="box box-success">
            <div class="box-body">
                ...
                <form id="edit_system_user_form" action="{{ url('operator/profile/update') }}" class="ui form add-user" method="post" accept-charset="utf-8">
                    ...
                    <div class="two fields">
                        ...
                        <div class="field">
                            ...
                            <input id="phone" class="block mt-1 w-full" type="text" placeholder="01000-000000" maxlength="12" value="@isset($userData->phone){{ $userData->phone }}@endisset" name="phone" class="readonly" disabled />
                        </div>
                    ...
                    <div class="two fields">
                        ...
                        <div class="field">
                            ...
                            <select id="gender" class="ui dropdown uppercase" name="gender" class="readonly" disabled>
                        ...
                        <div class="field">
                            ...
                            <select id="civilstatus" class="ui dropdown uppercase" name="civilstatus" class="readonly" disabled>
                    ...
                    <div class="two fields">
                        ...
                        <div class="field">
                            ...
                            <input id="division" class="block mt-1 w-full" type="text" value="@isset($userData->division){{ $userData->division }}@endisset" name="division" class="readonly" disabled />
                        </div>

                        <div class="field">
                            <label>{{ __("District") }}</label>
                            <input id="district" class="block mt-1 w-full" type="text" value="@isset($userData->district){{ $userData->district }}@endisset" name="district" class="readonly" disabled />
                        </div>
                    ...
                    <div class="field">
                        ...
                        <input id="thana" class="block mt-1 w-full" type="text" value="@isset($userData->thana){{ $userData->thana }}@endisset" name="thana" class="readonly" disabled />
                    </div>

                    <div class="field">
                        <label>{{ __("Postal Code") }}</label>
                        <input id="postal_code" class="block mt-1 w-full" type="tel" placeholder="0100" pattern="[0-9]{4}" value="@isset($userData->postal_code){{ $userData->postal_code }}@endisset" name="postal_code" class="readonly" disabled />
                    </div>

                    <div class="field">
                        <label>{{ __("Street") }}</label>
                        <input id="street" class="block mt-1 w-full" type="text" value="@isset($userData->street){{ $userData->street }}@endisset" name="street"  class="readonly" disabled/>
                    </div>
